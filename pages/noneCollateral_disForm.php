...
<!-- end suggestion cif -->
<?php
		$query = "SELECT * FROM loan_process WHERE loan_type='none-collateral' AND dis='0' ORDER BY max_id ASC";
			...
			while($row=mysql_fetch_array($result_reginfo)){
				...
				//check if already disburse
					if($check_dis=='0'){
						...
						echo"<script>window.location.href='index.php?pages=noneCollateral_disForm';</script>";
						}
				//////end check disburse
...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>Easy None-Collateral Loan Disbursement Form :</h1></div>
