...
<!-- end suggestion cif -->
<?php
	$query = "SELECT cif FROM register where appr='1' and cancel ='0' and dis='0' GROUP BY cif ASC";
        ...
        echo("</script>");
?>
<h3 class="tit">Search None-Disbursment :</h3>
		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_noneDis_list.php" target="_new">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%" class="nostyle">
		<tr>
			<th valign="top">Approval From :</th>
