...
<title>Transaction Customer List:</title>
...
<?php 					
			...
			/*echo"<script>alert('$type_of_staff,$performance,$br_no,$from,$to');</script>";*/
					echo "<h2><u>Deposit Customer List</u></h2>";
					echo"
			...
			<table width="1000px" cellpadding="0" cellspacing="0" height="auto" class="form_border" style="margin:0px; border-collapse:collapse" border="1" >
                            ...
                            <tbody>
                            	<?php
									$dp_info="Select cid,borrower,sex,cust_dob,sum(amount) amount,d.cur from deposit d inner join register r on d.cid=r.cif and r.type_cust ='new'  where d.date between '$from' and '$to' and d.cur='$getCur' group by cid,borrower,sex,cust_dob,d.cur";
