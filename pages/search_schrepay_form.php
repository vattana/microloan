...
<?php
	$query = "SELECT ld FROM loan_process where dis ='1' GROUP BY ld ASC";
        ...
        echo("</script>");
?>
<h3 class="tit">Search Schedule Repayment :</h3>
		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_schrepay_list.php" target="_new">
