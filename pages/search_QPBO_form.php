...
?>
<!-- start content-outer -->
<h3 class="tit">Quality Portfolio By Officer :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_QPBO_list.php" target="_new">
        ...
        <tr>
			<th valign="top">Staffs :</th>
			<td>	
            <select class="input-text" name="staff" id="staff" onkeypress="return handleEnter(this, event);">
                            <option value="0">--Choose staff--</option>
                             <?php 
								$str="Select * from staff_list";
								$sql=mysql_query($str);
        ...
        <tr>
			<th valign="top" align="right">Loan Type :</th>
			<td>
            	<select class="input-text" name="lt" id="lt">
