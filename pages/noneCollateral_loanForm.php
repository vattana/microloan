...
<!-- end suggestion cif -->
<?php
		$query = "SELECT cif FROM register where appr='1' and cancel ='0' and bcif='1' and bloan='0' and dis='0' and type_loan='none-collateral' 
		GROUP BY cif DESC";
...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>Easy None-Collateral Loan Form :</h1></div>
