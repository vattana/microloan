...
?>
<!-- start content-outer -->
<h3 class="tit">Daily Performance Form :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_perform_list.php" target="_new">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%" class="nostyle">
		<tr>
			<th valign="top">Registered From :</th>
        ...
        <tr>
			<th valign="top">Type of Staffs :</th>
			<td>	
                       <select name="type_of_staff" class="input-text" id="type_of_staff">
						<option value="0"> --Choose-- </option>
                  			<option value="byCO">By COs</option>
                            <option value="byRecommender">By Recommenders</option>
                		</select>
            </td>
            <th valign="top">Type of Performance :</th>
			<td>
            	<select name="performance" class="input-text" id="performance">
						<option value="0"> --Choose-- </option>
                  			<option value="dis">Disbursement</option>
                            <option value="nonedis">None-Disbursement</option>
                           	<!--<option value="appr">Loan Approval</option>
                            <option value="re_after_app">Loan Reject After Approval</option>-->
                            <option value="lr">Loan Request</option>
                            <!--<option value="all_re">All Loan Reject</option>-->
                </select>
            </td>
		</tr>
        <tr>
