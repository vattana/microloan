...
?>
<!-- start content-outer -->
<h3 class="tit">Future Interest By Period :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_future_interest_by_period.php" target="_new">
