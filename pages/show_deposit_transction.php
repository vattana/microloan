...
<?php 					
			...
			/*echo"<script>alert('$type_of_staff,$performance,$br_no,$from,$to');</script>";*/
					echo "<h2><u>Deposit Transaction</u></h2>";
					echo"
			...
			<table width="1000px" cellpadding="0" cellspacing="0" height="auto" class="form_border" style="margin:0px; border-collapse:collapse" border="1" >
							...
							<tr align="center" style=" background-color:#06F;color:#FFF;" height="28">
                                ...
                                <td width="180"><b>Saving Type</b></td>
                                <td width="100"><b>Period</b></td>
							</tr>	
							</thead>
                            <tbody>
                            	<?php
									$dp_info="Select distinct ld,cid,borrower,sex,cust_dob,amount,date date_saving,d.cur,isfix,d.period from deposit d inner join register r on d.cid=r.cif and r.type_cust ='new' where d.date between '$from' and '$to' and d.cur='$getCur'";
