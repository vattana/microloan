...
?>
<!-- start content-outer -->
<h3 class="tit">Withdraw Transaction :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_withdraw_transction.php" target="_new">
