...
?>
<!-- start content-outer -->
<h3 class="tit">Deposit Customer List :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_deposit_customer_list.php" target="_new">
