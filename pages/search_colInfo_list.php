...
<?php
		$query = "SELECT * FROM loan_process ORDER BY max_id ASC";
			...
			echo("</script>");
?>
<h3 class="tit">Print Collateral Information :</h3>
		<!-- start id-form -->
        <form name="sch" method="post" enctype="multipart/form-data" action="pages/collateral_report.php" target="_new">
		...
		<tr>
            <th>&nbsp;</th>
            <td valign="top">
                <input type="submit" value="Preview" class="form-submit" name="print_sch" id="print_sch"/>
