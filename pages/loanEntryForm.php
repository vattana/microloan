...
<?php
	...
	if(isset($_POST['save']) && ($getglcode!='0')){
							...
							if(!empty($installment_date) && !empty($myreg_date)&& !empty($reg_id) && ($myclassi_purpose!='0')){
									...
									$insert_date="INSERT INTO schedule(id,record_date,cid,ld,no_install,repayment_date,principal,interest,total,balance,response_co,currency,br_no)
											...
											echo"<script>window.location.href='index.php?pages=loanEntryForm';</script>";
												...
												/*echo"<script>alert('$i,$month,$end,$no_r,$no_installment,$period');</script>";*/
												//////////////////	
		...
		#---------------start THB-------------#
			if($cur=='THB'){	
			$pr=round($amount/$no_installment);	
		#-----------------------------forward-----------------------------------------------
				if($setting=='forward'){//check if forward
												...
												while($row=mysql_fetch_array($result_holi)){//start holiday
													...
													/////////////loop schedule
													  ///////////start calculate
																	...
																	$PMT = roundkhr(round($amount / $Rate_Plus_One),$set);	
																	//End PMT														
																	$int=roundkhr(round((($ba*$rate/100)/$myno_r*$days)),$set);
																	
																	$pa=roundkhr(round($PMT,2),$set);
																	if ($i!=$no_installment){
																		$pr=roundkhr(round($PMT-$int),$set);
																	}
																	else{
																		$pa=roundkhr(round($pr+$int),$set);	
																	}
...
"); 
				...
				#--------------end update address for schedule----------------#
					/*	echo"<script>window.location.href='index.php?pages=loanEntryForm';</script>";*/
						...
						echo"<script>window.location.href='index.php?pages=loanEntryForm&catch';</script>";
			}//end check empty
...
<!-- start content-outer -->
<h3 class="tit">Easy Individual Loan Form :</h3>
		...
		<td>	
            <select class="input-text" name="gllink" id="gllink" onkeypress="return handleEnter(this, event);">
                    <option value="0">--Select--</option>
                     <?php 
								$str_glname="Select * from glp_caption where cType='I' order by id ASC;";   
		...
		<tr>
			...
			<td><input type="text" class="input-text" name="lid" id="lid" value="<?php echo $ld; ?>" autocomplete="off" readonly/></td>
		</tr>
		<tr>
			<th valign="top">អ្នកខ្ចី :</th>
			<td>
            <input type="text" class="input-text" name="kh_bor" id="kh_bor" value="<?php echo $kh_borrower; ?>" readonly 
            style="font-family:khmer OS; size:10pt" size="16"/>
            </td>
            <th valign="top">Borrower :</th>
			<td>
            <input type="text" class="input-text" name="en_bor" id="en_bor" value="<?php echo $borrower; ?>" readonly/>
            </td>
		</tr>
        <tr>
			<th valign="top">អ្នករួមខ្ចី :</th>
			<td>
            <input type="text" class="input-text" name="kh_cobor" id="kh_cobor" value="<?php echo $kh_co_borrower; ?>" readonly 
            style="font-family:khmer OS; size:10pt" size="16"/>
            </td>
            <th valign="top">Co-Borrower :</th>
			<td>
            <input type="text" class="input-text" name="en_cobor" id="en_cobor" value="<?php echo $co_borrower; ?>" readonly/>
            </td>
		</tr>
        <tr>
			<th valign="top">Recommender :</th>
			<td>
            <input type="text" class="input-text" name="recom_name" id="recom_name" value="<?php echo $recommender; ?>" readonly/>
            </td>
            <th valign="top">CO's Name :</th>
			<td>
            <input type="text" class="input-text" name="co_name" id="co_name" value="<?php echo $co_name; ?>" readonly 
            style="font-family:khmer OS; size:10pt" size="16"/>
            </td>
		</tr>
         <tr>
			...
			<td>
            <input type="text" class="input-text" name="loan_amt" id="loan_amt" value="<?php echo $approval_amt; ?>" readonly/>
            <?php echo $l_currency; ?>
             <input type="hidden" name="cur" value=" <?php echo $l_currency; ?>" />
            </td>
            <th valign="top">Rate :</th>
			<td>
            <input type="text" class="input-text" name="rate" id="rate" value="<?php echo $approval_rate; ?>" readonly/>
            </td>
		</tr>
         <tr>
			<th valign="top">Period :</th>
			<td>
            <input type="text" class="input-text" name="period" id="period" value="<?php echo $approval_period; ?>" readonly/>
            <?php echo $show_fr; ?>
            </td>
