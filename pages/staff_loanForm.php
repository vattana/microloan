...
<!-- end suggestion cif -->
<?php
		$query = "SELECT cif FROM register where appr='1' and cancel ='0' and bcif='1' and bloan='0' and dis='0' and type_loan='staff' 
		GROUP BY cif DESC";
...
");
				...
				#--------------end update address for schedule----------------#
						echo"<script>window.location.href='index.php?pages=staff_loanForm';</script>";
				}
					else{
...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>Easy Staff Loan Form :</h1></div>
