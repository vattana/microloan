...
?>
<!-- start content-outer -->
<h3 class="tit">Total Interest And O/S :</h3>

		<!-- start id-form -->
        <form name="cust_request" method="post" enctype="multipart/form-data" action="pages/show_total_interest_os.php" target="_new">
